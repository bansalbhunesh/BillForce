...
export default function Home() {
  ...
  if (amt && d) {
    tax = amt * TAX_CONSTANTS.DISALLOWANCE_RATE;
    interest = amt * TAX_CONSTANTS.INTEREST_RATE * (d / 365);
    total = tax + interest;
  }
  ...
  return (
    <>
      ...
      <section className="min-h-[calc(100vh-56px)] grid grid-cols-1 md:grid-cols-2 items-center px-6 md:px-10 py-12 md:py-20 gap-10 md:gap-16 max-w-7xl mx-auto relative">
        <div>
          <div
            className="inline-block font-mono text-[11px] font-medium tracking-[0.12em] uppercase text-accent border border-accent px-2.5 py-1 rounded-sm mb-6 opacity-0 animate-fadeup"
            style={{ animationDelay: '0.1s' }}
          >
            For MSME suppliers
          </div>
          <h1
            className="font-serif text-4xl md:text-[3.8rem] leading-[1.15] tracking-tight opacity-0 animate-fadeup"
            style={{ animationDelay: '0.2s' }}
          >
            Stop chasing payments.
            <br />
            <em className="text-accent italic">Send a notice</em>
            <br />
            that actually works.
          </h1>
          <p
            className="mt-6 text-[17px] text-muted leading-relaxed max-w-[440px] opacity-0 animate-fadeup"
            style={{ animationDelay: '0.3s' }}
          >
            Section 43B(h) makes your buyer lose tax deductions for every day they delay past 45
            days. We turn that into a legally formatted notice in 2 minutes — without a CA, without
            a lawyer.
          </p>
          <div
            className="flex flex-wrap gap-3 mt-10 opacity-0 animate-fadeup"
          ...
          <div
            className="mt-10 flex gap-8 opacity-0 animate-fadeup"
        ...
        <div
          className="bg-white border border-border rounded-md shadow-[8px_12px_40px_rgba(0,0,0,0.08)] p-8 relative opacity-0 animate-fadein"
          style={{ animationDelay: '0.5s' }}
        >
          ...
          <div className="border-b-2 border-ink pb-3 mb-4">
            ...
            <div className="text-[11px] text-muted font-mono mt-0.5">
              Income Tax Act, 1961 — MSME Development Act, 2006
            </div>
          </div>
          <div className="text-[12.5px] leading-relaxed text-[#2a2520]">
            <p>
              To: <strong>Ramesh Auto Components Pvt. Ltd.</strong>
            </p>
            <p className="mt-2">
              This notice pertains to Invoice <strong>INV-2024-0891</strong> dated{' '}
              <strong>14 Jan 2025</strong> for services rendered, in the amount of{' '}
              <strong>₹8,40,000</strong>.
            </p>
            <p className="mt-2">
              As a registered MSME under Udyam Registration <strong>UDYAM-PB-06-0042381</strong>,
              the undersigned is protected under the MSMED Act, 2006. Under Section 43B(h) of the
              Income Tax Act, 1961, any unpaid MSME dues beyond 45 days become{' '}
              <strong>non-deductible</strong> for the payer in the relevant financial year.
            </p>
            ...
            <p className="text-[12px]">
              ...
              generated under the provisions of Section 43B(h) and may be referenced in Form 3CD
              filing.
            </p>
          </div>
      ...
      <section className="bg-ink text-paper py-20 px-6 md:px-10">
        <div className="max-w-[860px] mx-auto">
          <div className="font-mono text-[11px] tracking-[0.12em] uppercase text-accent mb-5">
            The reality
          </div>
          <h2 className="font-serif text-3xl md:text-[2.8rem] font-normal leading-[1.2] mb-6">
            You built something. They used it.
            <br />
            Now they <em className="text-[#f5a882] italic">won&apos;t pay.</em>
          </h2>
          <p className="text-[#b8b4ac] max-w-[560px] mt-4 text-[15px]">
            A WhatsApp message gets ignored. A phone call gets deferred. But a legal notice citing
            the exact tax penalty your buyer is accruing? That gets read by the finance team —
            today.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            <div className="border border-white/10 rounded-md p-6">
              ...
              <p className="text-[14px] text-[#b8b4ac] leading-relaxed">
                The tax hit a company faces on ₹1 crore of unpaid MSME invoices held past March 31.
                Most finance teams don&apos;t know until their CA tells them at audit.
              </p>
            </div>
            <div className="border border-white/10 rounded-md p-6">
              <div className="font-serif text-[2.8rem] text-accent leading-none mb-2">52%</div>
              <p className="text-[14px] text-[#b8b4ac] leading-relaxed">
                of B2B payments in India are already overdue beyond 90 days. Your buyer is probably
                already non-compliant and doesn&apos;t know it.
              </p>
            </div>
            <div className="border border-white/10 rounded-md p-6">
              <div className="font-serif text-[2.8rem] text-accent leading-none mb-2">45</div>
              <p className="text-[14px] text-[#b8b4ac] leading-relaxed">
                days is the legal limit. After that, your buyer&apos;s tax deduction disappears.
                After 60 days, bank interest on your unpaid dues is not deductible either.
              </p>
            </div>
            <div className="border border-white/10 rounded-md p-6">
              <div className="font-serif text-[2.8rem] text-accent leading-none mb-2">₹0</div>
              <p className="text-[14px] text-[#b8b4ac] leading-relaxed">
                is what a CA charges to send a notice like this. But a CA visit costs ₹5,000–15,000
                and takes a week to schedule. BillForce generates it in 2 minutes.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how" className="py-20 px-6 md:px-10 max-w-6xl mx-auto">
        <div className="font-mono text-[11px] tracking-[0.12em] uppercase text-accent mb-3 text-center">
          How it works
        </div>
        <h2 className="font-serif text-3xl md:text-[2.6rem] font-normal mb-12 text-center">
          Four steps. Two minutes.
          <br />A notice that means business.
        </h2>
          ...
          {[
            {
              ...
              desc: 'Photo, PDF, or fill a form. We extract the date, amount, and buyer details automatically.',
            },
            {
              num: '02',
              title: 'We verify your Udyam',
              desc: 'Enter your Udyam number once. We auto-verify via the government API and embed it in every notice.',
            },
            {
              num: '03',
              title: 'Notice generated',
              desc: 'A formatted PDF: invoice details, days overdue, exact tax exposure for the buyer, Section 43B(h) citation.',
            },
            {
              num: '04',
              title: 'Send via WhatsApp',
              desc: "Share the PDF directly from WhatsApp. Buyer's finance team gets a trackable link showing their live tax exposure.",
            },
          ].map((step, i) => (
            <div
              key={i}
              className="flex flex-col gap-2 p-6 bg-paper2 rounded-md border border-border relative"
            >
              ...
              {i < 3 && (
                <div className="hidden lg:block absolute -right-[15px] top-1/2 -translate-y-1/2 text-muted text-[18px]">
                  →
                </div>
              )}
            </div>
      ...
      <section id="calculator" className="py-20 px-6 md:px-10 max-w-4xl mx-auto">
        ...
        <h2 className="font-serif text-3xl md:text-[2.4rem] font-normal mb-2">
          See what your buyer is losing
          <br />
          by not paying you.
        </h2>
        <p className="text-muted mb-10 text-[15px]">
          Enter the invoice details below. This is exactly what appears in your notice.
        </p>

        <div className="bg-paper2 border border-border rounded-lg p-8">
          <div className="flex flex-col gap-1.5 mb-6">
            <label className="font-mono text-[12px] text-muted tracking-wide">
              Invoice amount (₹)
            </label>
            <input
              type="number"
          ...
          <div className="bg-ink text-paper rounded-md p-6 grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="flex flex-col gap-1">
              <div className="text-[11px] text-[#888] font-mono uppercase">
                Tax disallowance (30%)
              </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="font-serif text-[1.6rem] text-[#f5a882]">
                {formatCurrency(interest)}
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <div className="text-[11px] text-[#888] font-mono uppercase">
                Total buyer exposure
              </div>
      ...
      <section id="pricing" className="py-20 px-6 md:px-10 bg-paper2">
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <h2 className="font-serif text-3xl md:text-[2.4rem] font-normal mb-2">
            One price. Unlimited notices.
          </h2>
          <p className="mb-10 text-[15px] text-muted">
            Less than what you&apos;d lose in one day of delayed payment.
          </p>
          ...
          <div className="bg-white border border-border rounded-lg p-10 text-left relative">
            ...
            <div className="text-[12px] text-muted mb-6">
              No setup fee · Cancel anytime · Works on any Android
            </div>
